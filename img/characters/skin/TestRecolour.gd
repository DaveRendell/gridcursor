...
func _ready():
	var texture_rect = $TextureRect as TextureRect
	
	var base = Image.load_from_file("res://img/characters/skin/Human1.png")
	var palette = Image.load_from_file("res://img/characters/skin/skin-tones.png")
	
	var new_image = recolour_image(base, palette, 4)
